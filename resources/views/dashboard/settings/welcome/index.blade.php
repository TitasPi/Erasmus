      ...
      <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
        ...
        <div class="flex justify-center">
          <div class="bg-gray-100 rounded-lg border border-gray-200 w-96 text-gray-900">
            <a href="{{ route('dashboard.settings.welcome.navigation.index') }}" class="block px-6 py-2 border-b border-gray-200 w-full hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-0 focus:bg-gray-200 focus:text-gray-600 transition duration-500 cursor-pointer">
              Navigation items ⭐
            </a>
