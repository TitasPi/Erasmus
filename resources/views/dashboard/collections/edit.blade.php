      ...
      <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
        ...
        <form action="" method="post">
          ...
          <div class="mb-3 xl:w-96">
            ...
            <input type="text" class="form-input" id="name" name="name" placeholder="Enter name" value="{{ old('name') ?? $collection->name }}" />
          </div>
          <div class="mb-3 xl:w-96">
            <label for="icon" class="form-label inline-block mb-2 text-gray-700">Icon (shown to visitors)</label>
            <input type="text" class="form-input" id="icon" name="icon" placeholder="Enter icon" value="{{ old('icon') ?? $collection->icon }}" />
          </div>
          <div class="mb-3 xl:w-96">
            <label for="short_description" class="form-label inline-block mb-2 text-gray-700">Short Description</label>
            <input type="text" class="form-input" id="short_description" name="short_description" placeholder="Enter short description" value="{{ old('short_description') ?? $collection->short_description }}" />
          </div>
